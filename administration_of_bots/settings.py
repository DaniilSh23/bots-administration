"""
Django settings for administration_of_bots project.
...
INSTALLED_APPS = [
    ...
    'registration_bot',
    'vpn_bot',
    'service_desk_bot.apps.ServiceDeskBotConfig',
    # Установленные сторонние приложения
    'rest_framework',
]
...
ROOT_URLCONF = 'administration_of_bots.urls'
...
WSGI_APPLICATION = 'administration_of_bots.wsgi.application'
